        ...
        <form method="POST" action="{{ route('employee.requisitions.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <small class="text-muted">Selecting an item will auto-fill the fields below.</small>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="unit" id="unit_select" class="form-select @error('unit') is-invalid @enderror" required>
